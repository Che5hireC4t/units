...
class Pressure(AbstractQuantity):
    ...
    _UNITS = \
        {
            Unit('Pa', 'pascal'): 1.0,
            Unit('bar', 'bar'): 100000.0,
            Unit('atm', 'norm.atmosphere'): 101325.0,
            Unit('at', 'tech.atmosphere'): 98066.5,
            Unit('cmwat', 'water-cm'): 98.0638,
            Unit('inwat', 'water-inch'): 249.08890833333,
            Unit('mmHg', 'mercury-mm'): 133.322,
            Unit('torr', 'torr'): 133.322,
            Unit('inHg', 'mercury-inch'): 3386.389,
            Unit('ba', 'barye'): 0.1,
            Unit('pz', 'pieze'): 1000.0,
            Unit('psi', 'psi'): 6894.76
        }
