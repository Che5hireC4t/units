...
class Energy(AbstractQuantity):
    ...
    _UNITS = \
        {
            Unit('J', 'joule'): 1.0,                            # https://en.wikipedia.org/wiki/Joule
            Unit('cal', 'calorie'): 4.184,                      # https://en.wikipedia.org/wiki/Calorie
            Unit('eV', 'electron-volt'): 1.602176634e-19,       # https://en.wikipedia.org/wiki/Electronvolt
            Unit('toe', 'ton-oil-equivalent'): 41.868e9         # https://en.wikipedia.org/wiki/Tonne_of_oil_equivalent
        }
